...
<link type="text/css" rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/owner/ownerCoupon.css?ver=4">
		...
		<div id="coupon-enroll">
			...
			<form action="/couponEnroll.do" method="post">
				<div class="signUp-table">
					<div>쿠폰 이름</div>
					<div>
						<input type="text" name="owCouponName" 
							placeholder="쿠폰 이름" onkeydown="couponNameCheck();"
							onchange="couponNameCheck();">
				...
				<div class="signUp-table">
					...
					<div>
						<input type="number" name="couponCount" 
							min="-1" placeholder="쿠폰 개수(갯수 제한이 없으면 -1 입력)"
				...
				<div class="signUp-table">
					...
					<div>
						<input type="date" name="couponStartDate"
							onkeydown="dateCheck();" onchange="dateCheck();"> <span>
							- </span> <input type="date" name="couponExpireDate"
							 onkeydown="dateCheck();"
							onchange="dateCheck();">
				...
				<div class="signUp-table">
					<div>쿠폰 설명</div>
					<div>
						<textarea type="text" name="couponDetail"
							placeholder="쿠폰 상세 설명"></textarea>
						<p>쿠폰 설명을 입력해주세요</p>
					</div>
				</div>
				<div>
			...
			<div id="enrollCouponList">
				<table id="keywords" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td>바삭하게</td>
						<td>285</td>
						<td>2018/07/26 - 2018/08/09</td>
						<td>30% 할인된 가격으로 디너세트를 즐길 수 있습니다.30% 할인된 가격으로 디너세트를 즐길 수 있습니다.30% 할인된 가격으로 디너세트를 즐길 수 있습니다.</td>
						<td><button id="couponDelBtn" onclick="couponDel();">삭제</button></td>
					</tr>
				</tbody>
				</table>
				<p>${pageNaviData.startNavi} 안녕</p>
