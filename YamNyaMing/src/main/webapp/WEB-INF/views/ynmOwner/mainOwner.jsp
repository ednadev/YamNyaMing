...
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/owner.css?ver=4">
<script src="http://code.jquery.com/jquery.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.7.2/Chart.min.js"></script>	
<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.7.2/Chart.bundle.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/owner.js"></script>
</head>
<body>
	<header id="owner-main-header">
		...
		<p>
			[닉네임]님 ([아이디]) <a href="/index.jsp">로그아웃</a>
		</p>
	</header>
	<nav id="owner-main-nav">
		<ul>
			<li><a href="ownerInfo.do">정보 관리</a></li>
			<li><a href="storeManager.do">음식점 관리</a></li>
			<li><a href="reservationManager.do">예약 관리</a></li>
			<li><a href="couponManager.do">쿠폰 관리</a></li>
			<li><a href="boardOwner.do">게시판 관리</a></li>
			<li><a href="statOwner.do">통계 관리</a></li>
		</ul>
	</nav>
