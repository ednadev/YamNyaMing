...
var finalList3 = new Array("일식당","일본식라면","돈가스","샤브샤브","오니기리","오므라이스","우동,소바","일식튀김,꼬치","초밥,롤","카레","덮밥");
var finalList4 = new Array("스테이크,립","피자","햄버거","핫도그","후렌치후라이","샌드위치","브런치","해물,생선요리","이탈리아음식","스페인음식","프랑스음식","그리스,터키음식","독일음식","멕시코,남미음식");
var finalList5 = new Array("한식뷔페","고기뷔페","해산물뷔페","일식,초밥뷔페","채식,샐러드뷔페");
var finalList6 = new Array("카페","베이커리","케이크전문","도넛","와플","호두과자","떡,한과");
var finalList7 = new Array("패밀리레스토랑","아시아음식","베트남음식","인도음식","태국음식","도시락,컵밥","분식","치킨,닭강정");
