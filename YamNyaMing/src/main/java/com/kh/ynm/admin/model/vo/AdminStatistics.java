...
public class AdminStatistics {
	...
	private int memall5day;
	private int owall4day;
	private int memall4day;
	private int owall3day;
	private int memall3day;
	private int owall2day;
	private int memall2day;
	private int owallyesterday;
	private int memallyesterday;
	private int owalltoday;
	private int memalltoday;
...
public AdminStatistics(String today, String yesterday, String threeday, String fourday, String fiveday, String sixday,
		...
		int threedaynewmember, int fourdaynewowner, int fourdaynewmember, int fivedaynewowner, int fivedaynewmember,
		int sixdaynewowner, int sixdaynewmember, int sevendaynewowner, int sevendaynewmember, int member7day,
		int member15day, int member30day, int owner7day, int owner15day, int owner30day, int deletememtoday,
	...
	this.memall5day = memall5day;
	this.owall4day = owall4day;
	this.memall4day = memall4day;
	this.owall3day = owall3day;
	this.memall3day = memall3day;
	this.owall2day = owall2day;
	this.memall2day = memall2day;
	this.owallyesterday = owallyesterday;
	this.memallyesterday = memallyesterday;
	this.owalltoday = owalltoday;
	this.memalltoday = memalltoday;
...
public void setOwall6day(int owall6day) {
	this.owall6day = owall6day;
}

public int getMemall6day() {
	return memall6day;
}

public void setMemall6day(int memall6day) {
	this.memall6day = memall6day;
}

public int getOwall5day() {
	return owall5day;
}

public void setOwall5day(int owall5day) {
	this.owall5day = owall5day;
}

public int getMemall5day() {
	return memall5day;
}

public void setMemall5day(int memall5day) {
	this.memall5day = memall5day;
}

public int getOwall4day() {
	return owall4day;
}

public void setOwall4day(int owall4day) {
	this.owall4day = owall4day;
}

public int getMemall4day() {
	return memall4day;
}

public void setMemall4day(int memall4day) {
	this.memall4day = memall4day;
}

public int getOwall3day() {
	return owall3day;
}

public void setOwall3day(int owall3day) {
	this.owall3day = owall3day;
}

public int getMemall3day() {
	return memall3day;
}

public void setMemall3day(int memall3day) {
	this.memall3day = memall3day;
}

public int getOwall2day() {
	return owall2day;
}

public void setOwall2day(int owall2day) {
	this.owall2day = owall2day;
}

public int getMemall2day() {
	return memall2day;
}

public void setMemall2day(int memall2day) {
	this.memall2day = memall2day;
}

public int getOwallyesterday() {
	return owallyesterday;
}

public void setOwallyesterday(int owallyesterday) {
	this.owallyesterday = owallyesterday;
}

public int getMemallyesterday() {
	return memallyesterday;
}

public void setMemallyesterday(int memallyesterday) {
	this.memallyesterday = memallyesterday;
}

public int getOwalltoday() {
	return owalltoday;
}

public void setOwalltoday(int owalltoday) {
	this.owalltoday = owalltoday;
}

public int getMemalltoday() {
	return memalltoday;
}

public void setMemalltoday(int memalltoday) {
	this.memalltoday = memalltoday;
}
